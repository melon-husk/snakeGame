...
function draw() {
  ...
  for (let i = 0; i < snakeArr.length; i++) {
    ...
    ctx.strokeStyle = 'red';
    ctx.strokeRect(snake.x, snake.y, elementWidth, elementHeight);
  }
  ctx.drawImage(
    currentSnake.image,
    currentSnake.x,
...
function doIteration() {
  ...
  // } else {
  // }
  let newsd = {x:currentSnake.x,y:currentSnake.y,image:currentSnake.image,width:currentSnake.width,height:currentSnake.height};
  snakeArr.unshift(newsd);
