...
function moveSnakeByDirection(reverseDirection = false,_d = false ) {
  ...
  else if (_d == 'LEFT') return moveSnakeByDirection(true,'RIGHT');
  else if (_d == 'UP') return moveSnakeByDirection(true,'DOWN');
  else if (_d == 'RIGHT') return moveSnakeByDirection(true,'LEFT');
  else if (_d == 'DOWN') return moveSnakeByDirection(true,'UP');
}
...
function draw() {
  ...
  ctx.drawImage(currentSnake.image, currentSnake.x, currentSnake.y, currentSnake.width, currentSnake.height);
}
...
function doIteration() {
  ...
  if (collisionWithOther != false) {
    ...
    score += elementCollision.scoreChange;
    snakeGrowth += elementCollision.snakeLengthChange;
  }else if(reverseOnBorderCollision != false){
    moveSnakeByDirection(true);
   } else {
    snakeGrowth++;
  }
