...
function moveSnakeByDirection(reverseDirection = false,_d = false,callOneTime=false ) {
  ...
  else if (_d == 'LEFT' && !callOneTime)  moveSnakeByDirection(false,'RIGHT',true);
  else if (_d == 'UP' && !callOneTime)  moveSnakeByDirection(false,'DOWN',true);
  else if (_d == 'RIGHT' && !callOneTime)  moveSnakeByDirection(false,'LEFT',true);
  else if (_d == 'DOWN' && !callOneTime)  moveSnakeByDirection(false,'UP',true);
}
