...
function moveSnakeByDirection(reverseDirection = false) {
  ...
  //if(currentSnake.x<0 )currentSnake.x = 0;
  //if(currentSnake.y<0 )currentSnake.y = 0;
  ...
  else if (_d == 'LEFT') {currentSnake.x += elementWidth;keyboardDirection="RIGHT";}
  else if (_d == 'UP') {currentSnake.y += elementHeight;keyboardDirection="DOWN";}
  else if (_d == 'RIGHT') {currentSnake.x -= elementWidth;keyboardDirection="LEFT";}
  else if (_d == 'DOWN') {currentSnake.y -= elementHeight;keyboardDirection="UP";}
}
