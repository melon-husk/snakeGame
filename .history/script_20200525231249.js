...
function moveSnakeByDirection(reverseDirection = false,_d = false,callOneTime=false ) {
  ...
  else if (_d == 'LEFT')  moveSnakeByDirection(false,'RIGHT');
  else if (_d == 'UP' )  moveSnakeByDirection(false,'DOWN');
  else if (_d == 'RIGHT' )  moveSnakeByDirection(false,'LEFT');
  else if (_d == 'DOWN' )  moveSnakeByDirection(false,'UP');
}
