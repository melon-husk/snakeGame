...
function moveSnakeByDirection(_d = false, reverseDirection = false) {
  ...
  if (_d == 'LEFT' && !reverseDirection) currentSnake.x -= boxWidth;
  else if (_d == 'UP' && !reverseDirection) currentSnake.y -= boxHeight;
  else if (_d == 'RIGHT' && !reverseDirection) currentSnake.x += boxWidth;
  else if (_d == 'DOWN' && !reverseDirection) currentSnake.y += boxHeight;
