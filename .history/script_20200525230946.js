...
function moveSnakeByDirection(reverseDirection = false,_d = false,callOneTime=false ) {
  ...
  else if (_d == 'LEFT' && !callOneTime)  moveSnakeByDirection(true,'RIGHT',true);
  else if (_d == 'UP' && !callOneTime)  moveSnakeByDirection(true,'DOWN',true);
  else if (_d == 'RIGHT' && !callOneTime)  moveSnakeByDirection(true,'LEFT',true);
  else if (_d == 'DOWN' && !callOneTime)  moveSnakeByDirection(true,'UP',true);
}
